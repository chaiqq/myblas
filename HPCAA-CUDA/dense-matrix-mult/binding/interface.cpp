...
PYBIND11_MODULE(dense_hpc_aa, module) {
    ...
    // py::class_<namespace::classname>(module, "method name to construct this class in python")
    // def_readwrite("method used in python", &actual member function in c)
    // it's like using a class which is defined by c++ in python program
    ...
    // def("method for py", &actual_method in c, "description of the method") for common functions
}